<script>
        ...
        $('#new').click(function () {
            ...
            document.getElementById('htitle').innerText='Nuevo Marca';
            document.getElementById('btn').innerText='Guardar'

        });

        function editar($marca){
            console.log($marca.solicitud_id);
            action=2;
            var form= document.getElementById('userForm');
            form.action='{{route('marcas.update',0)}}';
            form.method='post';
            // form.files='true';
            form.enctype="multipart/form-data";
            ...
            //}
            $('#edit').modal('show');
            document.getElementById('htitle').innerText='Editar marca';
            document.getElementById('btn').innerText='Editar';
            $('#edit').find('.modal-body #descripcion').val($marca.descripcion);
            $('#edit').find('.modal-body #solicitud_id').val($marca.solicitud_id);
            $('#edit').find('.modal-body #id').val($marca.id);
        }
    </script>
